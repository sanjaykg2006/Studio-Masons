...
async function main() {
  ...
  await p.snagEntry.createMany({
    data: [
      { id: "#SN-102", projectName: PROJECTS.p1, title: "Master Bedroom", category: "Finishes & Painting", priority: "HIGH PRIORITY", status: "OPEN", description: "Paint peeling near AC duct in the south-west corner of the ceiling. Requires scraping and repaint.", assignee: "Eng. David K.", displayTime: "2 DAYS AGO", closed: false, accent: true, sortOrder: 1 },
      { id: "#SN-105", projectName: PROJECTS.p1, title: "Living Area Balcony", category: "Joinery", priority: "MEDIUM", status: "OPEN", description: "Alignment issue with the glass railing gaskets. Visual gap of 3mm observed on the left section.", assignee: "Ar. Sarah Chen", displayTime: "5 HOURS AGO", closed: false, accent: false, sortOrder: 2 },
      { id: "#SN-098", projectName: PROJECTS.p2, title: "Kitchen Pantry", category: "Joinery", priority: "LOW", status: "CLOSED", description: "Hinges for the corner cabinet need tightening and lubrication. Slight squeak on opening.", assignee: "Eng. Rajat P.", displayTime: "RESOLVED 1W AGO", closed: true, accent: false, sortOrder: 3 },
      { id: "#SN-110", projectName: PROJECTS.p3, title: "Bathroom Tiles", category: "Plumbing", priority: "HIGH PRIORITY", status: "OPEN", description: "Cracked tile near shower drain. Water seepage risk if not replaced before waterproofing stage.", assignee: "Eng. David K.", displayTime: "1 DAY AGO", closed: false, accent: true, sortOrder: 4 },
      { id: "#SN-111", projectName: PROJECTS.p4, title: "Staircase Railing", category: "Civil & Structure", priority: "MEDIUM", status: "OPEN", description: "Railing height is 50mm below code requirement. Needs extension plates welded on top.", assignee: "Ar. Sarah Chen", displayTime: "3 HOURS AGO", closed: false, accent: false, sortOrder: 5 },
    ],
  });
