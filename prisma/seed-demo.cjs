...
async function main() {
  ...
  await p.qualityChecklistCategory.createMany({
    data: [
      { name: "Precheck", items: [{ label: "Site safety clearance", linked: false }, { label: "Material check", linked: false }, { label: "Drawings verified", linked: false }, { label: "Base surface preparation", linked: true }], sortOrder: 1 },
      { name: "Postcheck", items: [{ label: "Cleanliness & debris removal", linked: false }, { label: "Curing duration verified", linked: false }, { label: "Protection of finished surfaces", linked: false }, { label: "Defects logged", linked: true }], sortOrder: 2 },
      { name: "Line Item Wise Checklist", items: [{ label: "Level and alignment tolerance", linked: false }, { label: "Gaps & joint filling", linked: false }, { label: "Operation of fixtures", linked: false }, { label: "Leakage/pressure testing", linked: true }], sortOrder: 3 },
    ],
  });
