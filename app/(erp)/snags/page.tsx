    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-[16px] text-[#666666] max-w-md">Use the <span className="font-bold text-[#e30613]">Project Selector</span> in the top bar to choose a project and view its snags.</p>
        </div>
      </div>
    );
  }
    ...
    <div>
      ...
      {snags.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center bg-[#f8f8f8] border border-[#e4e2e1] rounded-xl">
          ...
          <p className="text-[16px] text-[#666666] max-w-md">No snags have been raised for <span className="font-bold text-[#e30613]">{selectedProject.name}</span> yet.</p>
        </div>
      ) : (
